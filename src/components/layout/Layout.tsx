...
const PAGE_META: Record<string, { title: string; subtitle?: string }> = {
  ...
  '/portal/flourish-api': { title: 'Flourish API', subtitle: 'The soul layer for any AI — GCU ethical character as a service' },
  ...
  '/portal/executive-brief': { title: 'Executive Briefing', subtitle: 'Presidential summary · The case for GCU as the global authority on ethical AI' },
  '/portal/flourish-standard': { title: 'The Flourish Standard', subtitle: 'GCU\'s ethical AI certification framework · The industry standard we are creating' },
  ...
  '/portal/university-os': { title: 'University OS', subtitle: 'AI-powered command infrastructure for GCU operations' },
