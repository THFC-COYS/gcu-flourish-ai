      ...
      <div className="relative overflow-hidden rounded-2xl purple-gradient p-6 sm:p-8">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 shrink-0">
            <button onClick={() => navigate('/portal/library')} className="btn-gold text-xs px-4 py-2 flex items-center gap-1.5">
              <Heart size={13} /> Deploy a Spirit Agent
            </button>
            <button onClick={() => navigate('/portal/vision')} className="border border-white/30 text-white text-xs font-semibold px-4 py-2 rounded-lg hover:bg-white/10 transition-colors flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="page-card p-4 space-y-1">
            ...
            {[
              { label: 'Training Academy', sub: 'Practice with Spirit in role-play', icon: '🎓', to: '/portal/spirit-training' },
              { label: 'Spirit Network', sub: '847 alumni contributors', icon: '❤️', to: '/portal/spirit-network' },
              { label: 'Flourish API', sub: 'License the soul layer', icon: '⚡', to: '/portal/flourish-api' },
              { label: 'Vision & Roadmap', sub: 'Phase 1 → Phase 2', icon: '🚀', to: '/portal/vision' },
            ].map(l => (
              <button
                key={l.to}
