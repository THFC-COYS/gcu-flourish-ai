...
function FeatureDemos() {
  const demos = [
    ...
    },
    {
      ...
      href: '/molted/forge/agentic-grader',
      cta: 'See it grade',
      accent: TEAL,
      accentDim: TEAL_DIM,
      accentBorder: TEAL_BORDER,
    },
    {
      ...
      href: '/molted/forge/course-architect',
      cta: 'Build a course',
      accent: TEAL,
      accentDim: TEAL_DIM,
      accentBorder: TEAL_BORDER,
    },
    {
      ...
      href: '/molted/forge/auto-respond',
      cta: 'Draft a reply',
      accent: TEAL,
      accentDim: TEAL_DIM,
      accentBorder: TEAL_BORDER,
    },
    {
      ...
      href: '/molted/forge/early-warning',
      cta: 'See the signals',
      accent: TEAL,
      accentDim: TEAL_DIM,
      accentBorder: TEAL_BORDER,
