    ...
    <Slide>
      <div className="text-center">
        ...
        <p className="text-xl text-molted-muted max-w-2xl mx-auto leading-relaxed">
          Molt is an agentic learning platform built for scale. Every student. Every course. Every outcome — tracked, supported, and optimized in real time.
        </p>
    ...
    <Slide>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="p-8 rounded-2xl border border-molted-gold/20 bg-molted-gold/[0.04]">
          <h3 className="text-molted-white font-bold text-lg mb-4">What Molt does</h3>
          <ul className="space-y-3 text-molted-muted">
  ...
  return (
    <Slide>
      ...
      <h2 className="text-5xl md:text-6xl font-black text-molted-white leading-tight mb-8">
        ...
        <span className="text-molted-muted">Molt carries it.</span>
      </h2>
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <p className="text-molted-muted text-lg leading-relaxed">
            Generic AI gives every student the same experience. Molt's <strong className="text-molted-white">Spirit Layer</strong> encodes institutional character — values, voice, pastoral care — into every agent so students feel the university, not a chatbot.
          </p>
          <p className="text-molted-muted text-lg leading-relaxed">
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-8 py-5 border-b border-white/5 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-molted-muted text-sm font-medium">Molt &nbsp;·&nbsp; Executive Tour</span>
        </div>
