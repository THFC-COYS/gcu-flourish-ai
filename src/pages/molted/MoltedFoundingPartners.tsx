      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <RevealBlock delay={250}>
          <p className="mt-8 text-xl md:text-2xl text-molted-muted max-w-2xl mx-auto leading-relaxed">
            MoltLMS is accepting exactly 12 founding institutional partners.
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            ...
            'The institutions that partner with MoltLMS now won\'t be adopting AI. They\'ll be rebuilding from the first line of code — with us, ahead of everyone else.',
          ].map((p, i) => (
    ...
    <section className="py-32 px-6 border-t border-molted-border relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <RevealBlock className="text-center mb-16">
          ...
          <p className="mt-6 text-molted-muted text-lg max-w-2xl mx-auto">
            MoltLMS's agents don't wait to be asked. They watch. The moment a student
...
/* ── Page ──────────────────────────────────────────────────────────────── */
export default function MoltLMSFoundingPartners() {
  return (
    <MoltLMSLayout>
      <Cover />
      <TheProblem />
