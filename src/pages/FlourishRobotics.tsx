    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="page-card p-6 bg-gradient-to-r from-yju-primary/5 to-yju-accent/5 border-yju-primary/20 text-center">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <button onClick={() => navigate('/portal/vision')} className="btn-primary flex items-center gap-2">
            <ArrowRight size={16} /> See Full Vision
          </button>
          <button onClick={() => navigate('/portal/flourish-api')} className="btn-secondary flex items-center gap-2">
