  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'molted-glow': '0 0 60px rgba(123, 97, 255, 0.15), 0 0 120px rgba(123, 97, 255, 0.06)',
        'molted-violet': '0 4px 32px rgba(123, 97, 255, 0.25)',
        'molted-ember': '0 4px 32px rgba(255, 107, 53, 0.25)',
        'molted-card': '0 2px 24px rgba(0, 0, 0, 0.4)',
        'molted-card-hover': '0 8px 48px rgba(123, 97, 255, 0.2)',
      },
    },
  },
  plugins: [],
