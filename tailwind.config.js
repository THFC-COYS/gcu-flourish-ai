    ...
    extend: {
      colors: {
        ...
        molted: {
          ...
          elevated: '#111118',
          border: '#1E1E2E',
          /* Real logo: charcoal "molted" · gold "ed" · red "Ai" */
          charcoal: '#1E2D3D',
          gold: '#D4AF37',
          'gold-light': '#E8C94D',
          'gold-dark': '#B8962E',
      ...
      boxShadow: {
        ...
        'molted-glow': '0 0 60px rgba(212, 175, 55, 0.12), 0 0 120px rgba(212, 175, 55, 0.05)',
        'molted-violet': '0 4px 32px rgba(212, 175, 55, 0.25)',
        'molted-ember': '0 4px 32px rgba(204, 34, 0, 0.25)',
        'molted-gold': '0 4px 32px rgba(212, 175, 55, 0.30)',
        'molted-red': '0 4px 32px rgba(204, 34, 0, 0.28)',
        'molted-card': '0 2px 24px rgba(0, 0, 0, 0.4)',
        'molted-card-hover': '0 8px 48px rgba(212, 175, 55, 0.15)',
      },
    },
  },
  plugins: [],
